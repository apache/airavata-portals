...
<div
    ...
    if
    storage_resource_id
    %}data-storage-resource-id="{{ storage_resource_id }}"
    {%
    endif
    %}
    {%
    if
    compute_resource_id
    %}data-compute-resource-id="{{ compute_resource_id }}"
    {%
    endif
    %}
></div>
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div>
                    ...
                    <span
                        class="badge"
                        :class="
                            resource.enabled ? 'bg-success' : 'bg-secondary'
                        "
                    >
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input
                                class="form-control form-control-sm"
                                v-model="resource.storageResourceDescription"
                            />
                        </div>
                        <div class="col-md-6">
                            <div class="form-check">
                                ...
                                />
                                <label class="form-check-label" for="sr-enabled"
                                    >Enabled</label
                                >
                            </div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            ...
                            <div
                                v-else-if="connectionStatus === 'testing'"
                                class="text-primary"
                                style="font-size:0.8125rem;"
                            >
...
export default {
    ...
    methods: {
        ...
        async testConnection() {
            ...
            const onResult = (event) => {
                if (event.session_id === this.sessionId) {
                    this.connectionStatus = event.success
                        ? "connected"
                        : "failed";
                    this.connectionError = event.success ? "" : event.message;
                    if (utils.SSEClient)
                        utils.SSEClient.off("ssh_result", onResult);
                }
            };
        ...
        async confirmDelete() {
            if (
                !confirm("Delete this storage resource? This cannot be undone.")
            )
                return;
            try {
                await services.StorageResourceService.delete({
                    lookup: this.storageResourceId,
                });
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input
                                class="form-control form-control-sm"
                                type="number"
                                v-model.number="resource.cpusPerNode"
                            />
                        </div>
                        <div class="col-md-3">
                            ...
                            <input
                                class="form-control form-control-sm"
                                type="number"
                                v-model.number="resource.maxMemoryPerNode"
                            />
                        </div>
                        <div class="col-md-2">
                            ...
                            <input
                                class="form-control form-control-sm"
                                type="number"
                                v-model.number="resource.defaultNodeCount"
                            />
                        </div>
                        <div class="col-md-2">
                            ...
                            <input
                                class="form-control form-control-sm"
                                type="number"
                                v-model.number="resource.defaultCPUCount"
                            />
                        </div>
                        <div class="col-md-2">
                            <label class="form-label"
                                >Default Walltime (min)</label
                            >
                            <input
                                class="form-control form-control-sm"
                                type="number"
                                v-model.number="resource.defaultWalltime"
                            />
                        </div>
                        <div class="col-md-6">
                            <div class="form-check">
                                <input
                                    ...
                                    v-model="resource.enabled"
                                />
                                <label class="form-check-label" for="cr-enabled"
                                    >Enabled</label
                                >
                            </div>
                        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select
                                ...
                                v-model="jobSubmission.resourceManager"
                            >
                        ...
                        <div class="col-md-4">
                            <label class="form-label"
                                >Alternative SSH Host</label
                            >
                            <input
                                class="form-control form-control-sm"
                                v-model="jobSubmission.alternativeHost"
...
export default {
    ...
    methods: {
        ...
        async confirmDelete() {
            if (
                !confirm("Delete this compute resource? This cannot be undone.")
            )
                return;
            try {
...
```html
<a :href="'/resources/compute/' + resource.id" class="text-decoration-none"
        ...
        <div class="row align-items-center mb-3">
            <div class="col">
                ...
                <p class="text-muted mb-0">
                    Configure portal-wide settings for all users.
                </p>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            />
                            <div class="form-text">
                                Read-only identifier for this gateway.
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            />
                            <div class="form-text">
                                Set in settings_local.py as PORTAL_TITLE.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            >
                                ...
                                <option
                                    v-for="(name, id) in storageResources"
                                    :key="id"
                                    :value="id"
                                >
                                    {{ name }}
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <ssh-credential-selector
                                v-model="selectedCredentialToken"
                                :null-option="true"
                            />
                        </div>
                    </div>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-0" style="font-size:0.8125rem;">
                        Theme and branding settings are configured in
                        <code>settings_local.py</code>.
                    </p>
                </div>
            </div>
        ...
        async loadSettings() {
            ...
            try {
                ...
                this.storageResources =
                    await services.StorageResourceService.names();
            } catch {
                this.storageResources = {};
            }
            ...
            try {
                ...
                const profile = await utils.FetchUtils.get(
                ...
                if (
                    ...
                    profile.storagePreferences.length > 0
                ) {
...
<div
    ...
    if
    portal_title
    %}data-portal-title="{{ portal_title }}"
    {%
    endif
    %}
></div>
