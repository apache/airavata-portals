...
@register.inclusion_tag("django_airavata_wagtail_base/includes/main_menu_navs.html", takes_context=True)
...
def gateway_icon(context):
    ...
    return {"gateway_icon": gateway_icon}
...
@register.inclusion_tag("django_airavata_wagtail_base/includes/extra_web_resources.html", takes_context=True)
