...
urlpatterns = [
    ...
    re_path(r'^experiments/(?P<experiment_id>[^/]+)/setup-errors/$',
            views.ExperimentSetupErrorListView.as_view(),
            name="experiment-setup-errors"),
    re_path(r'^notifications/setup-errors/$',
            views.UserSetupErrorListView.as_view(),
            name="user-setup-errors"),
